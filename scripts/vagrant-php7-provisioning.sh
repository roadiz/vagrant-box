...
sudo cp /vagrant/scripts/vagrant/php-pool.conf /etc/php/7.0/fpm/pool.d/www.conf;
sudo cp /vagrant/scripts/vagrant/xdebug.ini /etc/php/7.0/mods-available/xdebug.ini;
sudo cp /vagrant/scripts/vagrant/logs.ini /etc/php/7.0/mods-available/logs.ini;
sudo cp /vagrant/scripts/vagrant/opcache-recommended.ini /etc/php/7.0/mods-available/opcache-recommended.ini;
